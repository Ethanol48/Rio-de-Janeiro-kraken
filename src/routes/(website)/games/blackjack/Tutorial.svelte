...
<div class="mb-6 flex w-[280px] flex-col gap-3 md:flex-row md:justify-center">
	<Carousel.Root class="w-[280px]" opts={{ loop: true }} bind:api={emblaApi} {plugins}>
		<Carousel.Content>
			<Carousel.Item>
				<CardUI.Root class="h-full min-h-[280px] w-full min-w-[280px]">
					<CardUI.Content class="flex h-full w-full flex-col pt-9">
						<div class="flex h-full w-full">
							<div class="relative flex h-full w-full flex-col justify-between">
								...
								<p class="mt-[-1] text-center">Card Count: <strong>{18}</strong></p>
							</div>
							...
							<div class="relative flex h-full w-full flex-col justify-between">
								...
								<p class="mt-[-1] text-center">Card Count: <strong>{17}</strong></p>
							</div>
						</div>

						<h4 class="mt-3 text-center">
							The point of the game is to have a better <br /> hand than the dealer !!
						</h4>
					</CardUI.Content>
				</CardUI.Root>
			</Carousel.Item>
			<Carousel.Item>
				<CardUI.Root class="min-h-[280px] min-w-[280px]">
					<CardUI.Content class="flex h-full w-full justify-between pt-9">
						...
						<div class="flex flex-col items-center justify-between">
							...
							<p class="typography text-center">
								Aces can either have a <br /> value of <strong>1</strong> or <strong>11</strong>
							</p>
						</div>
					</CardUI.Content>
				</CardUI.Root>

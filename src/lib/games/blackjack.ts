...
export const Value = (card: Card) => {
  switch (card.symbol) {
    case Carta.Two: return 2;
    case Carta.Three: return 3;
    case Carta.Four: return 4;
    case Carta.Five: return 5;
    case Carta.Six: return 6;
    case Carta.Seven: return 7;
    case Carta.Eight: return 8;
    case Carta.Nine: return 9;
    case Carta.Ten: return 10;
    case Carta.Jack: return 10;
    case Carta.Queen: return 10;
    case Carta.King: return 10;
    case Carta.Ace: return 11;
  }
...
export function createCards(): Card[] {
  ...
  const suits = [Color.SPADES, Color.HEARTS, Color.CLOVERS, Color.DIAMONDS];
  const symbols = [Carta.Two, Carta.Three, Carta.Four, Carta.Five, Carta.Six, Carta.Seven, Carta.Eight, Carta.Nine, Carta.Ten, Carta.Jack, Carta.Queen, Carta.King]
...
function colorToString(input: Color): string {
  switch (input) {
    case Color.SPADES: return "S";
    case Color.HEARTS: return "H";
    case Color.DIAMONDS: return "D";
    case Color.CLOVERS: return "C";
  }
}


function symbolToString(input: Carta): string {
  switch (input) {
    case Carta.Two: return "2"
    case Carta.Three: return "3"
    case Carta.Four: return "4"
    ...
    case Carta.Eight: return "8"
    case Carta.Nine: return "9"
    case Carta.Ten: return "T"
    case Carta.Jack: return "J"
    case Carta.Queen: return "Q"
    case Carta.King: return "K"
    case Carta.Ace: return "A"
  }
}

function stringToColor(input: string): Color {
  switch (input) {
    case "S": return Color.SPADES;
    case "H": return Color.HEARTS;
    case "D": return Color.DIAMONDS;
    case "C": return Color.CLOVERS;
    default:
...
function stringToSymbol(input: string): Carta {
  switch (input) {
    case "2": return Carta.Two;
    case "3": return Carta.Three;
    case "4": return Carta.Four;
    case "5": return Carta.Five;
    case "6": return Carta.Six;
    case "7": return Carta.Seven;
    case "8": return Carta.Eight;
    case "9": return Carta.Nine;
    case "T": return Carta.Ten;
    case "J": return Carta.Jack;
    case "Q": return Carta.Queen;
    case "K": return Carta.King;
    case "A": return Carta.Ace;
    default:
...
function CardToString(card: Card) {
  ...
  let result = "";
  result += colorToString(card.color)
  result += symbolToString(card.symbol)
}
...
export function CardsToString(cards: Card[]) {
  ...
  result += CardToString(cards[cards.length - 1])
  return result;
}
